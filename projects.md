---
layout: default
title: Projects Portfolio - Eva-Christin Ernst
permalink: /projects/
---
...
<div class="projects-container">
  ...
  <div class="projects-grid">
    ...
    <div class="project-card glass-card reveal-on-scroll">
      ...
      <div class="project-content">
        <h3 class="project-title">West Coast Wave Initiative (WCWI)</h3>
        <p class="project-description">
    ...
    <div class="project-card glass-card reveal-on-scroll proj-gold">
      ...
      <div class="project-content">
        ...
        <div class="project-tags">
          ...
          <span class="project-tag">Thermal Load Test</span>
          <span class="project-tag">Materials Testing</span>
    ...
    <div class="project-card glass-card reveal-on-scroll">
      ...
      <div class="project-content">
        <h3 class="project-title">International Industrial Drying Systems</h3>
        <p class="project-description">
          Designing, planning, and commissioning massive thermal drying plants for chemical and food processing factories globally.
        </p>
        <div class="project-tags">
          <span class="project-tag">Mechanical Engineering</span>
          <span class="project-tag">Thermal Fluid Dynamics</span>
          <span class="project-tag">Cost Estimation</span>
          <span class="project-tag">On-Site Commissioning</span>
        </div>
