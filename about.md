---
layout: default
title: About Me - Eva-Christin Ernst
permalink: /about/
---
...
<div class="about-container">
  ...
  <div class="section-header">
    <span class="section-pre">About Me</span>
    <h2 class="section-title">Professional Background &amp; Credentials</h2>
    <p style="margin: 1.5rem auto 0 auto; text-align: center; max-width: 650px;">
      A comprehensive look into my career bridging people leadership, project delivery, and energy engineering, alongside formal executive credentials.
    </p>
  </div>

  <!-- Interactive Unified Category Filter Buttons -->
  <div class="timeline-filters">
    <button class="timeline-filter-btn filter-active" data-filter="all">Show All</button>
    <button class="timeline-filter-btn" data-filter="leadership">Leadership &amp; PM</button>
    <button class="timeline-filter-btn" data-filter="mechanical">Engineering &amp; Tech</button>
    <button class="timeline-filter-btn" data-filter="international">International Experience</button>
  </div>

  <!-- Centered Pill Switcher for Tabbed Navigation -->
  <div class="about-tabs-wrapper">
    <div class="about-tabs-container">
      <div class="tab-active-bg" id="tab-indicator"></div>
      <button class="about-tab-btn tab-active" data-tab="timeline">Career Journey</button>
      <button class="about-tab-btn" data-tab="credentials">Credentials &amp; Certifications</button>
    </div>
  </div>

  <!-- Pane 1: Career & Academic Journey (Timeline) -->
  <div class="about-tab-pane pane-active" id="pane-timeline">
  ...
  <!-- Pane 2: Professional Credentials & Continuing Education (Grid) -->
  <div class="about-tab-pane" id="pane-credentials">
    <div class="credentials-grid">

      <!-- Credential: Oxford Artificial Intelligence Programme (Gold Accent) -->
      <div class="credential-card card-gold reveal-on-scroll" data-categories="leadership mechanical">
        <div class="credential-card-header">
          ...
          <span class="credential-badge">AI &amp; Tech</span>
        </div>
        <h3 class="credential-title">Oxford Artificial Intelligence Programme</h3>
        <div class="credential-institution"><strong>Saïd Business School, University of Oxford</strong> &bull; 08/2026</div>
        <p class="credential-description">
          Executive certificate programme covering technical AI foundations, enterprise deployment, and strategic AI governance. Grade: 94.0% (Cohort Average: 83.7%). Covered machine learning paradigms, neural networks, computer vision, ethical AI governance, and business case development.
        </p>
      </div>
      ...
      <div class="credential-card reveal-on-scroll" data-categories="leadership">
        ...
        <h3 class="credential-title">Leading with Values – Stability &amp; Presence</h3>
      ...
      <div class="credential-card card-gold reveal-on-scroll" data-categories="leadership mechanical">
        <div class="credential-card-header">
          ...
          <span class="credential-badge">Legal &amp; Tech</span>
        </div>
        <h3 class="credential-title">Execution of Construction Projects (VOB/B &amp; VOB/C)</h3>
        <div class="credential-institution"><strong>BPM BauProjektManagement</strong>, Berlin &bull; 10/2023</div>
        <p class="credential-description">
          Detailed training in German public construction law, managing contract changes, executing defect claims, and handling delay claims under standard VOB regulations.
        </p>
      </div>
      ...
      <div class="credential-card reveal-on-scroll" data-categories="leadership">
        ...
        <h3 class="credential-title">Leading and Developing Teams</h3>
        <div class="credential-institution"><strong>TÜV Nord Akademie</strong> &bull; 06/2022</div>
        <p class="credential-description">
          Succession planning and team lifecycle dynamics, employee motivation, systemic problem-solving, and establishing Continuous Improvement Processes (CIP).
        </p>
      </div>
      ...
      <div class="credential-card card-gold reveal-on-scroll" data-categories="leadership">
        ...
        <h3 class="credential-title">(Junior) Manager &amp; PM Core Foundations</h3>
